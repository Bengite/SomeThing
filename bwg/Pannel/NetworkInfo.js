        ...
        { type: 'stack', direction: 'row', alignItems: 'center', gap: 6, children: [
            ...
            { type: 'stack', direction: 'row', alignItems: 'center', gap: 2, children: [
             //   { type: 'image', src: 'sf-symbol:tornado', color: pingColor, width: 12, height: 12 },
               { type: 'text', text: pingMs > 0 ? `${pingMs}` : "--", font: { size: 12, weight: 'bold' }, textColor: C.muted },
               { type: 'text', text: 'ms', font: { size: 12, weight: 'medium' }, textColor: C.muted }
            ]}
        ]},
        { type: 'spacer', length: 8 },
        { type: 'stack', direction: 'column', alignItems: 'start', gap: 8, children: [
            buildRow('dot.radiowaves.left.and.right', C.blue, '内网', r1Content),
