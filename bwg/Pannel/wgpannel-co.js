...
export default async function (ctx) {
  ...
  const C = {
    ...
    lightText: { light: '#00000055', dark: '#FFFFFF55' },
    lightText2: { light: '#00000077', dark: '#FFFFFF77' },
    lightText3: { light: '#000000AA', dark: '#FFFFFFAA' },
    lightText4: { light: '#000000CC', dark: '#FFFFFFCC' },
    lightText5: { light: '#000000DD', dark: '#FFFFFFDD' },
